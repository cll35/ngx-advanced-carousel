import { AfterViewInit, ChangeDetectorRef, ElementRef, EventEmitter, NgZone, OnChanges, OnDestroy, QueryList, Renderer2, SimpleChanges, TemplateRef } from "@angular/core";
import { ControlValueAccessor } from "@angular/forms";
import { Observable } from "rxjs";
export declare class NgxAdvancedCarouselComponent implements ControlValueAccessor, AfterViewInit, OnDestroy, OnChanges {
    private platformId;
    private _document;
    private _renderer;
    private _zone;
    ...
    private readonly rootElmHeight;
    private containerElmWidth;
    private containerElmHeight;
