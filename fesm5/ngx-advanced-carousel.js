...
import { Directive, EventEmitter, Component, ViewEncapsulation, forwardRef, ChangeDetectionStrategy, Inject, PLATFORM_ID, Renderer2, NgZone, ChangeDetectorRef, Input, Output, ViewChild, ViewChildren, ContentChildren, ElementRef, ContentChild, NgModule } from '@angular/core';
...
var NgxAdvancedCarouselComponent = /** @class */ (function () {
    ...
    function (showNum) {
        if (!this.originalData.length) {
            this.originalData = __spread(this.data);
        }
        if (this.infinite) {
